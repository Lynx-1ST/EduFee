...
- Khi khởi động, nếu MoMo Sandbox đang bật, ứng dụng tự truy vấn lại các đơn `Pending/Unknown` đã lưu. Thành công sẽ tạo biên lai nguyên tử, thất bại sẽ được đóng, còn lỗi mạng vẫn để lại cho lần kiểm tra sau. Có thể chạy thủ công từ **Cài đặt → Kiểm tra lại giao dịch MoMo đang chờ**.
